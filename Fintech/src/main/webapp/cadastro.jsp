...
<head>
  <meta charset="UTF-8">
  <title>FinanceEasy - Cadastro</title>
...
<div class="main-container">
  ...
  <div class="left-section">
    <div class="login-box">
      ...
      <form action="cadastro" method="post" class="w-100">
        <div class="mb-3">
        ...
        <div class="mb-3">
          <input type="text" class="form-control" placeholder="CPF" name="cpf" required
                 value="${param.cpf != null ? param.cpf : ''}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          <input type="password" class="form-control" placeholder="Confirmar senha" name="confirmarSenha" required>
        </div>
  ...
  <div class="right-section">
    <img src="./resources/login.png" alt="Cadastro Financeiro">
  </div>
</div>
